...
describe('Cases from app.js', () => {
  ...
  describe('apples', () => {
    ...
    it('should be an array and have apples.length', () => {
      const apples = cases.apples;
      expect(apples).to.have.lengthOf(4);
    });
    // write a test to check to see if the apples array contains 'Red Delicious'.
    // expect(array).to.contain('Red Delicious');
    it('should return apples contain Red Delicious', () => {
      const apples = cases.apples;
  ...
  describe('Ben', () => {
    ...
    it('should return favBand as Beastie Boys', () => {
      const favBand = cases.Ben;
      expect(favBand).to.include({ favBand: 'Beastie Boys' });
    });
  });
  ...
  describe('Sean', () => {
    ...
    it('should return favFood as Pizza', () => {
      const Sean = cases.Sean;
      expect(Sean).to.include({ favFood: 'Pizza' });
    });
  });
  ...
  describe('Ryan', () => {
    ...
    it('should return favBook as Harry Potter', () => {
      const Ryan = cases.Ryan;
      expect(Ryan).to.not.include({ favBook: 'Harry Potter' });
    });
  });
  ...
  describe('Austen', () => {
    ...
    it('should return favColor not Gold', () => {
      const Austen = cases.Austen;
      expect(Austen).to.not.include({ favColor: 'Gold' });
    });
  });
  ...
  describe('Ivan', () => {
    ...
    it('should return favActivity as Rock Climbing', () => {
      const Ivan = cases.Ivan;
      expect(Ivan).to.include({ favActivity: 'Rock Climbing' });
    });
  });
});
